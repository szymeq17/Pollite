...
class CompletedSurveyServiceTest {
    ...
    void shouldProperlyCalculateSurveyResultsWithoutFilters() {
        ...
        assertThat(question1.getTotal()).isEqualTo(2L);
        assertThat(question2.getTotal()).isEqualTo(2L);
        assertThat(question3.getTotal()).isEqualTo(2L);

        assertThat(question1Answer1.getTotal()).isEqualTo(2);
        assertThat(question1Answer1.getPercentage().longValue()).isEqualTo(100L);
        assertThat(question1Answer2.getTotal()).isEqualTo(0);
        assertThat(question1Answer2.getPercentage().longValue()).isEqualTo(0L);
        assertThat(question1Answer3.getTotal()).isEqualTo(0);
        assertThat(question1Answer3.getPercentage().longValue()).isEqualTo(0L);
    }
